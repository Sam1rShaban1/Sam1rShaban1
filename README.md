...
<table>
  <tr>
    ...
    <td width="50%">
      ...
      <p>GitOps-managed 5-node Raspberry Pi cluster: MQTT → NATS JetStream → VictoriaMetrics with full Prometheus/Grafana/Loki/Tempo observability.</p>
      <p><code>K3s</code> <code>ArgoCD</code> <code>EMQX</code> <code>Ansible</code></p>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3><a href="https://github.com/Sam1rShaban1/Air-Quality-ML">🌫️ Air-Quality ML</a></h3>
      <p>Hybrid WOA-CNN-BiLSTM-AM model for PM2.5 forecasting with swarm-based hyperparameter tuning; R = 0.87 across 234 engineered features.</p>
      <p><code>TensorFlow</code> <code>Whale Optimization</code> <code>Attention</code></p>
    </td>
    <td width="50%">
  ...
  <tr>
    ...
    <td width="50%">
      ...
      <p>Recent document-revalidation product (Python backend + TypeScript frontend) with structured editing and automated scoring.</p>
      <p><code>Python</code> <code>TypeScript</code> <code>React</code></p>
    </td>
  </tr>
</table>
